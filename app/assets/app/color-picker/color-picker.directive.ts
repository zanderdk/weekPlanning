import {Component, DynamicComponentLoader, Directive, Input, Output, ViewContainerRef, ElementRef, EventEmitter, OnInit, Inject} from '@angular/core';
import {ColorPickerService} from './color-picker.service';
import {Rgba, Hsla, Hsva, SliderPosition, SliderDimension} from './classes';

const styleUrls: string[] = ['assets/app/color-picker/color-picker.css'];
const templateUrl: string = 'assets/app/color-picker/color-picker.html';
...
export class ColorPickerDirective implements OnInit {
    ...
    constructor(@Inject(DynamicComponentLoader) private dcl: DynamicComponentLoader,
                ...
                @Inject(ColorPickerService) private service: ColorPickerService) {
        this.created = false;
    }
